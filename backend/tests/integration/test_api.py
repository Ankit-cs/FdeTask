...
from src.models.domain import ErrorEvent, TokenEvent
...
async def test_artifact_roundtrip(client: httpx.AsyncClient, clean_db):
    ...
    from src.db.repos import ArtifactRepo, SessionRepo
...
async def test_no_double_terminal_frame_when_engine_emits_after_done(
    ...
    from src.models.domain import Citation, DoneEvent, TokenEvent, Usage
