...
class LocalRagEngine:
    ...
    async def stream_reply(
        ...
        try:
            ...
            # 4. Citations from database truth
            ...
            if self._settings.allow_extractive_fallback and chunks:
                fallback_text = "I am currently offline or experiencing an error, but here are the exact quotes I found from Lenny's podcast regarding your question:\n\n"
