...
from src.routes.errors import ConflictError, NotFoundError
from src.routes.sse import sse_stream
from src.util.logging import get_logger
from src.models.api import SendMessageRequest
...
async def send_message(
    ...
    log.info("request.start", session_id=str(session_id), trace_id=trace_id)
