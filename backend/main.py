...
from src.middleware.middleware import RequestContextMiddleware
from src.routes.routes_artifacts import router as artifacts_router
from src.routes.routes_config import router as config_router
from src.routes.routes_health import router as health_router
from src.routes.routes_messages import router as messages_router
from src.routes.routes_sessions import router as sessions_router
from src.api.routes_soup import router as soup_router
from src.util.config import get_settings
from src.db.pool import apply_schema, create_pool
from src.db.repos import ArtifactRepo, KnowledgeRepo, MessageRepo, SessionRepo
from src.service.engines.router import EngineRouter
from src.util.logging import configure_logging, get_logger
from src.service.rag import embedder
...
def create_app(lifespan_ctx=lifespan) -> FastAPI:
    ...
    for router in (health_router, config_router, sessions_router, messages_router, artifacts_router, soup_router):
